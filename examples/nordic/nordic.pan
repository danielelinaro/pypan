...
Dc dc nettype=1 print=0 printnodes=0 sparse=2 gminstepping=false \
      ggroundstepping=no
Pz pz nettype=1 shift=3.276152e-01 mem=yes
...
#else
U1   ud1  uq1  tap1  ULTC TW=20+10.5
U1py ud1  gnd  uq1  gnd  tap1py  gnd  PYULTC TW=20+10.5
#endif // PAN
...
#ifndef PAN
model PYULTC nport macro=yes setup="pyultc_setup" evaluate="pyultc_eval"
#endif
